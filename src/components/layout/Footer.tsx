...
export default function Footer() {
	return (
		<footer className="fixed right-0 bottom-0 left-0 flex justify-between text-sm py-2 px-11 border-t-1 border-gray-300 dark:border-gray-600 bg-app-white-themed">
